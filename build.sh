...
pushd build-esp32s3
cmake -DCMAKE_TOOLCHAIN_FILE=../toolchains/esp32s3.toolchain.cmake -DNCNN_OPENMP=OFF -DNCNN_THREADS=OFF -DNCNN_RUNTIME_CPU=OFF -DNCNN_SIMPLEOCV=ON -DNCNN_BUILD_BENCHMARK=OFF -DNCNN_STDIO=OFF ..
make -j4
make install
popd
